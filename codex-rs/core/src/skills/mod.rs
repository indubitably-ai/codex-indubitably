...
pub(crate) use injection::build_effective_skill_descriptors;
pub(crate) use injection::build_selected_skill_descriptors;
pub(crate) use injection::build_skill_injections;
pub(crate) use injection::collect_explicit_skill_mentions;
pub(crate) use injection::skill_descriptor;
